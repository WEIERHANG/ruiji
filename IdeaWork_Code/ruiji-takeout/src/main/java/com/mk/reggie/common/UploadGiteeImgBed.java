...
public class UploadGiteeImgBed {
     ...
     * 码云私人令牌
     */
    public static final String ACCESS_TOKEN = "e433389d6d856f287b3a52c23525000a";  //这里不展示我自己的了，需要你自己补充

    /**
     * 码云个人空间名，改成自己的，如果不知道个人空间名可以看下面的图片
     */
    public static final String OWNER = "lucky_h";
     ...
     * @return
     */
    public static String createUploadFileUrl(String fileName) {
